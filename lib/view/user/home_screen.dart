...
import 'package:smart_quiz/theme/theme.dart' show AppTheme;
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> _fetchCategories() async {
    final snalshot = await FirebaseFirestore.instance
        .collection('categories')
        .orderBy('createdAt', descending: true)
        .get();

    setState(() {
      _allCategories = snalshot.docs
  ...
  void _filterCategories(String query, {String? categoryFilter}) {
    setState(() {
      _filteredCategories = _allCategories.where((category) {
        ...
        return matchesearch && matchesCategory;
      }).toList();
    });
  }
